...
var _user$project$HTTP$Model = function (a) {
	return {link: a};
};
var _user$project$HTTP$init = {
	ctor: '_Tuple2',
	_0: _user$project$HTTP$Model(''),
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var Elm = {};
Elm['HTTP'] = Elm['HTTP'] || {};
if (typeof _user$project$HTTP$main !== 'undefined') {
    _user$project$HTTP$main(Elm['HTTP'], 'HTTP', undefined);
}
